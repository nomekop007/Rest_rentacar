...
const RecepcionAutorizada = require.resolve("../images/Recepcion_Autorizada.png");

async function actaTrasladoDestinoPlantilla(data) {
    ...
    return {
        ...
        {text: 'Acta de Traslado Sucursal Destino', style: 'subheader'},
        {
            text: "\n"
        },
		{
        ...
        {
            text: "El documento generado deja constancia de la recepcion del vehiculo con la informacion presentada anteriormente. Documento valido en sucursales Rent a Car"
        },
        {
            text: "\n"
        },
...

        {
                width: 100,
                height: 100,
                image: "data:image/jpeg;base64," + (await base64(RecepcionAutorizada)),
                alignment: "center",
            },
...
module.exports = actaTrasladoDestinoPlantilla;