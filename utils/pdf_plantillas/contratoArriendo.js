    ...
    content: [
      ...
      },
      {
        ...
        text: [
          ...
          {
            text:
              `OCTAVO: Respecto del vehículo arrendado, queda prohibido al arrendatario: \n` +
