...
async function contratoPlantilla(data) {
    ...
    const extencion = data.extencion;

    const doc = {
        extencion: `EXTENCION - ${data.n_extencion}`,
        conductores: {
            nombre1: "",
            nombre2: "",
            nombre3: "",
        ...
        fechaInicio: formatFechahora(extencion.fechaInicio_extencion),
        fechaFin: formatFechahora(extencion.fechaFin_extencion),
    };


    const arrayAccesorios = extencion.pagosArriendo.pagosAccesorios;
    ...
    switch (tipoArriendo) {
        ...
        case "REEMPLAZO":
            ...
            const pagoRemplazo = extencion.pagosArriendo;
    ...
    const facturacion = extencion.pagosArriendo.pagos[0].facturacione;
    if (facturacion) {
            ...
            columns: [
                [{
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            {},
                            {
                                text: `AUTO/CAMIONETA: \n ${extencion.vehiculo.tipo_vehiculo}`,
                                colSpan: 1,
                            },
                            ],
                            [{
                            ...
                            {
                                text: `MARCA MODELO: \n ${extencion.vehiculo.marca_vehiculo}  ${extencion.vehiculo.modelo_vehiculo}`,
                                colSpan: 1,
                            },
                            ],
                            [{
                            ...
                            {
                                text: `PATENTE: \n ${extencion.vehiculo.patente_vehiculo}`,
                                colSpan: 1,
                            },
                            ],
                            [{
                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        fontSize: 6,
                        margin: [0, 5, 10, 0],
                        text: `Observaciones: \n ${extencion.pagosArriendo.observaciones_pagoArriendo
                            } `,
                    },
                    ],
                },
                        ...
                        body: [
                            ...
                            [
                                "SUB TOTAL NETO:",
                                {
                                    text: "$ " +
                                        formatter.format(
                                            extencion.pagosArriendo.subtotal_pagoArriendo
                                        ),
                                    fontSize: 7,
                                },
                            ],
                            [
                                "DESCUENTO (-) :",
                                {
                                    text: "$ " +
                                        formatter.format(
                                            extencion.pagosArriendo.descuento_pagoArriendo
                                        ),
                                    fontSize: 7,
                                },
                            ],
                    ...
                    table: {
                        ...
                        body: [
                            [
                                "TOTAL NETO: \n\n IVA: \n\n TOTAL:",
                                {
                                    text: `$ ${formatter.format(
                                        extencion.pagosArriendo.neto_pagoArriendo
                                    )} \n\n $ ${formatter.format(
                                        extencion.pagosArriendo.iva_pagoArriendo
                                    )} \n\n $ ${formatter.format(
                                        extencion.pagosArriendo.total_pagoArriendo
                                    )} `,
                                    fontSize: 7,
                                },
                            ],
                            [
                                ...
                                {
                                    text: "$ " +
                                        formatter.format(extencion.pagosArriendo.total_pagoArriendo),
                                    fontSize: 10,
                                    bold: true,
                                },
                            ],
